...
PREPROCESS = T.Compose([
    T.Resize((224, 224)),
    T.ToTensor(),
    # ImageNet stats — these are the right normalization for ResNet18
    # whether or not we use pretrained weights; the architecture is
    # tuned for inputs in this distribution.
