...
at inference time) and adds:
    ...
    - A CLI for the same operations (``python face_cropper.py --help``)
...
--------------------
    ...
    # Whole directory
    python face_cropper.py crop-dir ./raw ./crops --recursive --resize 224

    # Idempotent rerun with a summary report
    python face_cropper.py crop-dir ./raw ./crops --recursive \\
...
# Re-export FaceDetector so `from face_cropper import FaceDetector` works.
